...
class WhiteFoxGoals_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'white-fox-goals'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'white-fox-goals'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'white-fox-goals'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'white-fox-goals'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'white-fox-goals');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'white-fox-goals'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'white-fox-goals');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'white-fox-goals'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'white-fox-goals') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'white-fox-goals');
            case 'false':
                return __('false', 'white-fox-goals');

            case 'Administrator':
                return __('Administrator', 'white-fox-goals');
            case 'Editor':
                return __('Editor', 'white-fox-goals');
            case 'Author':
                return __('Author', 'white-fox-goals');
            case 'Contributor':
                return __('Contributor', 'white-fox-goals');
            case 'Subscriber':
                return __('Subscriber', 'white-fox-goals');
            case 'Anyone':
                return __('Anyone', 'white-fox-goals');
        }
        return $optionValue;
    }
